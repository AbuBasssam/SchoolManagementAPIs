...
{
    public class GetUserByUserNameQueryHandler : IRequestHandler<GetUserByUserNameQuery, Response<UserQueryDTO>>
    {
        ...
        public GetUserByUserNameQueryHandler(IUserService UserServices, ResponseHandler responseHandler)//, IMapper mapper
        {
            //_mapper = mapper;
