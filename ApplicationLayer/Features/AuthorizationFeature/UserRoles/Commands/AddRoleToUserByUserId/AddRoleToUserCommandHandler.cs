    ...
    IRequestHandler<AddRoleToUserByUserIdCommand, Response<string>>
{
    ...
    #region Constructor
    public AddRoleToUserByUserIdCommandHandler(IUserService userService, IAuthService authorizationService, IStringLocalizer<SharedResoruces> stringLocalizer) : base(stringLocalizer)
    {
